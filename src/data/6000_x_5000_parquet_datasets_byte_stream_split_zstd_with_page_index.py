...
output_dir1 = "src/data/table1_dataset_byte_stream_split_zstd_with_page_index"
output_dir2 = "src/data/table2_dataset_byte_stream_split_zstd_with_page_index"
...
def save_dataframe_in_chunks(df, output_dir, chunk_size):
    for start in range(0, len(df), chunk_size):
        ...
        pq.write_table(table, file_path, write_page_index=True, compression="ZSTD", use_byte_stream_split=True)
