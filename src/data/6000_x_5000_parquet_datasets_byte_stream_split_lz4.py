...
output_dir1 = "src/data/table1_dataset_byte_stream_split_lz4"
output_dir2 = "src/data/table2_dataset_byte_stream_split_lz4"
...
def save_dataframe_in_chunks(df, output_dir, chunk_size):
    for start in range(0, len(df), chunk_size):
        ...
        pq.write_table(table, file_path, compression="LZ4", use_byte_stream_split=True)
